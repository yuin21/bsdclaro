                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6 col-sm-6">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                    <span class="text-bold tag-detalle">SOT: </span>
                                    {{ $pago->estado_carpeta }}
                                </li>
                                <li class="list-group-item">
                                    <span class="text-bold tag-detalle">SEC: </span>
                                    {{ $pago->pago_1er_recibo }}
                                </li>
                                <li class="list-group-item">
                                    <span class="text-bold tag-detalle">Nro. Proyecto: </span>
                                    {{ $pago->pago_dace }}
                                </li>
                                <li class="list-group-item">
                                    <span class="text-bold tag-detalle">Nro. Oportunidad: </span>
