...
class ImportFileController extends Controller
{
    ...
    {
        $this->middleware('can:admin.import_file.index');
    }
    ...
    public function index()
    {
        ...
        return view('admin.importfile.index', compact('data'));
    }
    ...
    public function parseImport(CsvImportRequest $request)
    {
        ...
        return view('admin.importfile.parseImport', [
    ...
    public function processImport(Request $request)
    {
        ...
        return redirect()->route('admin.importfile.index')->with('success', 'Datos guardados correctamente.');
    }
}
